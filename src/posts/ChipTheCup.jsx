    ...
    <div className="font-mono ">
      <div className="font-mono">
        ...
        <a
          ...
          className="mb-4 pt-2 text-md underline  underline-offset-2 text-pink-500 font-bold hover:text-sky-400 transition duration-300 ease-in-out transform-gpu hover:scale-105 "
        >
