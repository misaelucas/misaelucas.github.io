    ...
    <div className="font-mono ">
      <div className="font-mono">
        <p className="mb-4 mt-2 text-lg">
          Nos últimos meses eu tenho investido a maior parte do tempo tentando
          cuidar da minha saúde mental, entre eiras e beiras, conquistei
          estabilidade suficiente para amar minhas idiossincrasias, depois de
          tanto tempo...
        </p>

        <p className="mb-4 mt-2 text-lg">
          Imagino que a ideia de referências seja um tanto boba, pois todo
          escritor decente preza exclusivamente pela emoção, pela experiência,
          pelo correlato objetivo. Ainda tô tentando abandonar minha vaidade
          intelectual (COITADOOOO), mas é um negócio difícil assimilar a
          sabedoria "não só na memória, senão nos olhos, no coração, no
          estômago." Esse aqui vale referenciar, o livro me ajudou muito -
        ...
        <p className="mb-4 mt-2 text-lg">
          ...
          era ruim. Fico feliz de perceber o progresso. Tô refatorando ele, e
        ...
        <p className="mb-4 mt-2 text-lg">
          "Ocasionalmente, deixo cair uma xícara de chá para quebrar no chão de
          propósito. Não fico satisfeito quando não se recompõe. Algum dia,
          talvez, aquela xícara retornará"
        </p>
        ...
        <a
          ...
          className="mb-4 pt-2 text-md underline  underline-offset-2 text-pink-500 font-bold hover:text-sky-400 transition duration-300 ease-in-out transform-gpu hover:scale-105 hover:text-white "
        >
          Chip the Cup - Song by Patriot Series
        </a>
      </div>
    </div>
  );
