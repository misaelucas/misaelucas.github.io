      ...
      <div className="bio-container">
        ...
        <div className="shenanigans">
          <p>
            ...
            <a href="https://betrybe.com/" className="trybe-link">
              Trybe
            </a>
            . I also enjoy playing Chess and Muay Thai.
          </p>
          <p>
            This is my personal page, feel free to browse through, here you will
            be able to find my portfolio, stuff about me and a few shenanigans..
          </p>
        </div>
